...
from coderapp.forms import CursoFormulario, ProfesorFormulario,UserRegistrationForm, UserEditForm, AvatarFormulario
...
def buscar_camada(request):
    if request.method == "GET":
        ...
        return HttpResponse("Se buscó la camada {camada}")
